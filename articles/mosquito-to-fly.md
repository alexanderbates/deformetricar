...
# Shoot the neuropils AND the whole aedes brain hull, so the hull deforms too.
...
ggplot_flow_gif(flows[c("outer", show)], cols = cols_all, alpha = alpha_all,
                rotation_matrix = rmat, delay = 0.25,
