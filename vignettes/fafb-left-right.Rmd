...
the same class you give it). With `flow = TRUE` it returns *every* geodesic
timepoint, which `ggplot_flow_gif()` animates with `nat.ggplot`: the flipped brain
(red) flowing onto the translucent original.
